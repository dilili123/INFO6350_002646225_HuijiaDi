...
public class FcmSender {
  ...
  private static void sendMessageToFcmRegistrationToken() throws Exception {
    String registrationToken = "dFNdO5RERieJdIkQHS0YUH:APA91bHyID9XtqE-sCPH4m8OuwlzSl0gqEHEYWZEq1yLiGXy3DgZuLkPEtTXBw38sZ8gh7hJOQVe4JY-0laKmDOiyY-FhYaRZWMgH7YtsBPeRhKIY0p56m0";
    Message message =
        Message.builder()
