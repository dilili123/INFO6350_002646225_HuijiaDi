...
class NewPostPageWidget extends StatefulWidget {
  const NewPostPageWidget({super.key});

  @override
  State<NewPostPageWidget> createState() => _NewPostPageWidgetState();
}

class _NewPostPageWidgetState extends State<NewPostPageWidget> with RouteAware {
  ...
  void initState() {
    ...
    _model.textController1 ??=
        TextEditingController(text: 'Enter title of the item')
          ..addListener(() {
            debugLogWidgetClass(_model);
          });
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??= TextEditingController(text: 'Enter price')
      ..addListener(() {
        debugLogWidgetClass(_model);
      });
    ...
    _model.textController3 ??=
        TextEditingController(text: 'Enter description of the item')
          ..addListener(() {
            debugLogWidgetClass(_model);
          });
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(0xFFEF9239),
            ...
            FlutterFlowIconButton(
              ...
              onPressed: () async {
                await PostRecord.collection.doc().set(createPostRecordData(
                      ...
                      i1: _model.uploadedFileUrl1,
                      i2: _model.uploadedFileUrl2,
                      i3: _model.uploadedFileUrl3,
                      i4: _model.uploadedFileUrl4,
                    ));
                context.safePop();
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    ...
                    backgroundColor: Color(0xFF60E23B),
                  ),
                );
              },
            ),
            ...
            children: [
              Align(
                ...
                child: Stack(
                  children: [
                    Align(
                      alignment: AlignmentDirectional(-0.71, -0.88),
                      child: Container(
                        width: 200.0,
                        child: TextFormField(
                    ...
                    Align(
                      alignment: AlignmentDirectional(-0.42, -0.34),
                      child: Container(
                        width: 300.0,
                        child: TextFormField(
                    ...
                    Align(
                      alignment: AlignmentDirectional(-0.54, 0.41),
                      child: Container(
                        width: 114.0,
                        height: 100.0,
                    ...
                    Align(
                      alignment: AlignmentDirectional(0.47, 0.41),
                      child: Container(
                        width: 114.0,
                        height: 100.0,
                        decoration: BoxDecoration(
                    ...
                    Align(
                      alignment: AlignmentDirectional(-0.54, 0.78),
                      child: Container(
                        width: 112.0,
                        height: 100.0,
                        decoration: BoxDecoration(
